...
context.read('classpath:mocks/sandbox/operations.js')
context.read('classpath:mocks/sandbox/patch-patient.js')
context.read('classpath:mocks/sandbox/post-patient.js')
context.read('classpath:mocks/sandbox/get-coverage-retrieve.js')
context.read('classpath:mocks/sandbox/post-coverage.js')
