...
def post_patient_multiple_times(healthcare_worker_auth_headers: dict, pds_url: str) -> list:
    ...
    body = json.dumps({"type":"object","properties":{"nhsNumberAllocation":{"type":"string","description":"FHIR resource type.",
                        "enum":["Done"],"example":"Done"}},"required":["nhsNumberAllocation"]})
