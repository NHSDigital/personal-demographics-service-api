...
class TestUserRestrictedPatientAccess:
    ...
    async def test_patient_access_denied_p5_scope(
        ...
        assert token["body"]["error_description"] == "you have tried to requests authorization \
        but your application is not configured to use this authorization grant type"
